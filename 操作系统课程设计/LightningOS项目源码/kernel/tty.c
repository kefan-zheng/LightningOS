	...
	if (!(key & FLAG_EXT)) {
		...
		case UP:
			...
			else
			{
				if(TESTATASK == 2)
				{
					addRandomValue2048(doProcess(0));
				}
				else if(TESTATASK == 3)
				{
					getKeysnake(0);
		...
		case DOWN:
			...
			else
			{
				if(TESTATASK == 2)
				{
					addRandomValue2048(doProcess(2));
				}
				else if(TESTATASK == 3)
				{
					getKeysnake(2);
		...
		case LEFT:
			if(TESTATASK == 2)
			{
				addRandomValue2048(doProcess(3));
			}
			else if(TESTATASK == 3)
			{
				getKeysnake(3);
		...
		case RIGHT:
			if(TESTATASK == 2)
			{
				addRandomValue2048(doProcess(1));
			}
			else if(TESTATASK == 3)
			{
				getKeysnake(1);
		...
		case ESC:
			...
			{
				change_checkAction(-1);
			}
			else if(TESTATASK == 3)
			{
				changeiscontinue_snake(0);
			}
			else if(TESTATASK == 4)
			{
				gomexit();
		...
		case F5:
			...
			else
			{
				...
				{
					change_checkAction(0);
				}
				else if(TESTATASK == 3)
				{
					changeiscontinue_snake(1);
				}
				else if(TESTATASK == 4)
				{
					gomrestart();
